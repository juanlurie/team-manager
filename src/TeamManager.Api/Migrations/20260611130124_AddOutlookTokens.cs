...
{
    /// <inheritdoc />
    public partial class AddOutlookTokens : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OutlookTokens", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OutlookTokens_TeamMembers_TeamMemberId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OutlookTokens_TeamMemberId",
                table: "OutlookTokens",
                column: "TeamMemberId");
        }
