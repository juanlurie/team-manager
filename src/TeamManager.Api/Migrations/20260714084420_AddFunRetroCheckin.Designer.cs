...
namespace TeamManager.Api.Migrations
{
    ...
    [Migration("20260714084420_AddFunRetroCheckin")]
    partial class AddFunRetroCheckin
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TeamManager.Api.Domain.Entities.FunRetroCard", b =>
                {
                    ...
                    b.Property<string>("AssigneeMemberIdsJson")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("TeamManager.Api.Domain.Entities.FunRetroCheckinQuestion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("FunRetroCheckinQuestions");
                });

            modelBuilder.Entity("TeamManager.Api.Domain.Entities.FunRetroCheckinResponse", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("QuestionId", "MemberId")
                        .IsUnique()
                        .HasDatabaseName("IX_FunRetroCheckinResponse_Question_Member");

                    b.ToTable("FunRetroCheckinResponses");
                });
            ...
            modelBuilder.Entity("TeamManager.Api.Domain.Entities.FunRetroSession", b =>
                {
                    ...
                    b.Property<string>("IcebreakerAnswersJson")
                        .HasColumnType("text");

                    b.Property<string>("IcebreakerQuestion")
                        .HasColumnType("text");

                    b.Property<bool>("ManuallyRevealed")
                        .HasColumnType("boolean");

                    b.Property<int>("MaxVotesPerCard")
                        .HasColumnType("integer");

                    b.Property<bool>("ParticipationTracking")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("TeamManager.Api.Domain.Entities.FunRetroToken", b =>
                {
                    ...
                    b.HasIndex("SessionId")
                        .HasDatabaseName("IX_FunRetroToken_SessionId");

                    b.ToTable("FunRetroTokens");
                });
            ...
            modelBuilder.Entity("TeamManager.Api.Domain.Entities.RetroBoardAction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("RetroBoardSessionId")
                        .HasDatabaseName("IX_RetroBoardAction_SessionId");

                    b.HasIndex("SourceNoteId");

                    b.ToTable("RetroBoardActions");
                });

            modelBuilder.Entity("TeamManager.Api.Domain.Entities.RetroBoardCheckinQuestion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("RetroBoardSessionId")
                        .HasDatabaseName("IX_RetroBoardCheckinQuestion_SessionId");

                    b.HasIndex("SourceActionId");

                    b.ToTable("RetroBoardCheckinQuestions");
                });

            modelBuilder.Entity("TeamManager.Api.Domain.Entities.RetroBoardCheckinResponse", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid>("RetroBoardCheckinQuestionId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("RetroBoardCheckinQuestionId", "MemberId")
                        .IsUnique()
                        .HasDatabaseName("IX_RetroBoardCheckinResponse_QuestionId_MemberId");

                    b.ToTable("RetroBoardCheckinResponses");
                });

            modelBuilder.Entity("TeamManager.Api.Domain.Entities.RetroBoardColumn", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("RetroBoardSessionId")
                        .HasDatabaseName("IX_RetroBoardColumn_SessionId");
            ...
            modelBuilder.Entity("TeamManager.Api.Domain.Entities.RetroBoardNote", b =>
                {
                    ...
                    b.Property<Guid>("RetroBoardColumnId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TeamManager.Api.Domain.Entities.RetroBoardParticipant", b =>
                {
                    ...
                    b.HasIndex("RetroBoardSessionId", "MemberId")
                        .IsUnique()
                        .HasDatabaseName("IX_RetroBoardParticipant_SessionId_MemberId");

                    b.ToTable("RetroBoardParticipants");
                });

            modelBuilder.Entity("TeamManager.Api.Domain.Entities.RetroBoardParticipantProgress", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid>("RetroBoardParticipantId")
                        .HasColumnType("uuid");

                    b.HasKey("Id");

                    b.HasIndex("RetroBoardParticipantId", "Phase")
                        .IsUnique()
                        .HasDatabaseName("IX_RetroBoardParticipantProgress_ParticipantId_Phase");

                    b.ToTable("RetroBoardParticipantProgress");
                });

            modelBuilder.Entity("TeamManager.Api.Domain.Entities.RetroBoardSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<bool>("HideNotesUntilReveal")
                        .HasColumnType("boolean");
                    ...
                    b.HasIndex("CreatedByMemberId")
                        .HasDatabaseName("IX_RetroBoardSession_CreatedByMemberId");
                    ...
                    b.HasIndex("SquadId")
                        .HasDatabaseName("IX_RetroBoardSession_SquadId");

                    b.ToTable("RetroBoardSessions");
                });

            modelBuilder.Entity("TeamManager.Api.Domain.Entities.RetroBoardVote", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("RetroBoardNoteId", "MemberId")
                        .HasDatabaseName("IX_RetroBoardVote_NoteId_MemberId");

                    b.ToTable("RetroBoardVotes");
                });
            ...
            modelBuilder.Entity("TeamManager.Api.Domain.Entities.RetroCardReaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("TeamManager.Api.Domain.Entities.RetroCustomTheme", b =>
                {
                    ...
                    b.Property<string>("OverridesBuiltInId")
                        .HasColumnType("text");

                    b.HasKey("Id");

                    b.HasIndex("OverridesBuiltInId")
                        .IsUnique()
            ...
            modelBuilder.Entity("TeamManager.Api.Domain.Entities.Sprint", b =>
                {
                    ...
                    b.Property<string>("RetroIcebreakerAnswersJson")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("RetroTimerJson")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("TeamManager.Api.Domain.Entities.FunRetroCheckinResponse", b =>
                {
                    b.HasOne("TeamManager.Api.Domain.Entities.FunRetroCheckinQuestion", "Question")
                        .WithMany("Responses")
            ...
            modelBuilder.Entity("TeamManager.Api.Domain.Entities.Poll", b =>
                {
                    ...
                    b.HasOne("TeamManager.Api.Domain.Entities.FunRetroSession", "RetroSession")
                        .WithMany()
                        .HasForeignKey("RetroSessionId");

                    b.Navigation("CreatedByMember");

                    b.Navigation("RetroSession");
                });
            ...
            modelBuilder.Entity("TeamManager.Api.Domain.Entities.RetroBoardAction", b =>
                {
                    b.HasOne("TeamManager.Api.Domain.Entities.TeamMember", "Owner")
                        .WithMany()
                    ...
                    b.HasOne("TeamManager.Api.Domain.Entities.RetroBoardNote", "SourceNote")
                        .WithMany()
            ...
            modelBuilder.Entity("TeamManager.Api.Domain.Entities.RetroBoardCheckinQuestion", b =>
                {
                    ...
                    b.HasOne("TeamManager.Api.Domain.Entities.RetroBoardAction", "SourceAction")
                        .WithMany()
            ...
            modelBuilder.Entity("TeamManager.Api.Domain.Entities.RetroBoardCheckinResponse", b =>
                {
                    ...
                    b.HasOne("TeamManager.Api.Domain.Entities.RetroBoardCheckinQuestion", "Question")
                        .WithMany("Responses")
                        .HasForeignKey("RetroBoardCheckinQuestionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TeamManager.Api.Domain.Entities.RetroBoardNote", b =>
                {
                    ...
                    b.HasOne("TeamManager.Api.Domain.Entities.RetroBoardColumn", "Column")
                        .WithMany("Notes")
                        .HasForeignKey("RetroBoardColumnId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("TeamManager.Api.Domain.Entities.RetroBoardParticipantProgress", b =>
                {
                    b.HasOne("TeamManager.Api.Domain.Entities.RetroBoardParticipant", "Participant")
                        .WithMany("Progress")
                        .HasForeignKey("RetroBoardParticipantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TeamManager.Api.Domain.Entities.RetroCardReaction", b =>
                {
                    b.HasOne("TeamManager.Api.Domain.Entities.RetroCard", null)
                        .WithMany()
                        .HasForeignKey("CardId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
