...
namespace TeamManager.Api.Migrations
{
    ...
    [Migration("20260514051847_AddMeetingSeriesSlotClaim")]
    partial class AddMeetingSeriesSlotClaim
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TeamManager.Api.Domain.Entities.MeetingSession", b =>
                {
                    ...
                    b.Property<Guid?>("SessionDefinitionId")
                        .HasColumnType("uuid");

                    b.Property<Guid?>("SessionDefinitionSlotId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("SessionDefinitionId");

                    b.HasIndex("SessionDefinitionSlotId")
                        .IsUnique()
            ...
            modelBuilder.Entity("TeamManager.Api.Domain.Entities.SessionDefinition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("SessionDefinitions");
                });

            modelBuilder.Entity("TeamManager.Api.Domain.Entities.SessionDefinitionBooking", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("SessionDefinitionSlotId", "TeamMemberId")
                        .IsUnique();

                    b.ToTable("SessionDefinitionBookings");
                });

            modelBuilder.Entity("TeamManager.Api.Domain.Entities.SessionDefinitionParticipant", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("SessionDefinitionParticipants");
                });

            modelBuilder.Entity("TeamManager.Api.Domain.Entities.SessionDefinitionSlot", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("SessionDefinitionSlots");
                });
            ...
            modelBuilder.Entity("TeamManager.Api.Domain.Entities.MeetingSession", b =>
                {
                    ...
                    b.HasOne("TeamManager.Api.Domain.Entities.SessionDefinition", "SessionDefinition")
                        .WithMany()
                        .HasForeignKey("SessionDefinitionId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("TeamManager.Api.Domain.Entities.SessionDefinitionSlot", "SessionDefinitionSlot")
                        .WithMany()
                        .HasForeignKey("SessionDefinitionSlotId")
                        .OnDelete(DeleteBehavior.SetNull);
                    ...
                    b.Navigation("SessionDefinition");

                    b.Navigation("SessionDefinitionSlot");
                });
            ...
            modelBuilder.Entity("TeamManager.Api.Domain.Entities.SessionDefinitionBooking", b =>
                {
                    b.HasOne("TeamManager.Api.Domain.Entities.SessionDefinitionSlot", "Slot")
                        .WithMany("Bookings")
                        .HasForeignKey("SessionDefinitionSlotId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
