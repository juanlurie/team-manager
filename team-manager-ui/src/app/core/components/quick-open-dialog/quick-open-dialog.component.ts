...
const QUICK_OPEN_ITEMS: QuickOpenItem[] = [
  ...
  { id: 'sprints', path: '/delivery/sprints', label: 'Sprints', icon: 'directions_run', featureKey: 'sprints' },
  { id: 'features', path: '/delivery/features', label: 'Features', icon: 'view_list', featureKey: 'features' },
  { id: 'progress', path: '/delivery/progress', label: 'Progress', icon: 'track_changes', featureKey: 'progress' },
  ...
  { id: 'timesheet', path: '/team/timesheet', label: 'Timesheet', icon: 'schedule', featureKey: 'team' },
  { id: 'leave', path: '/team/leave', label: 'Leave', icon: 'event_busy', featureKey: 'leave' },
  { id: 'meetings', path: '/meetings', label: 'Meetings', icon: 'event', featureKey: 'meetings' },
  { id: 'export', path: '/delivery/export', label: 'Export', icon: 'download', featureKey: 'export' },
  ...
  { id: 'win-of-the-month', path: '/fun/win-of-the-week#month', label: 'Win of the Month', icon: 'workspace_premium', featureKey: 'win-of-month' },
  ...
  { id: 'expense-claim', path: '/team/expense-claim', label: 'Expense Claim', icon: 'receipt_long', featureKey: 'expense-claim' },
  ...
  { id: 'session-types', path: '/meetings/settings', label: 'Session Types', icon: 'category' },
  { id: 'slot-locations', path: '/meetings/settings', label: 'Slot Locations', icon: 'location_on', featureKey: 'meetings' },
  { id: 'access-requests', path: '/team/access-requests', label: 'Access Requests', icon: 'person_add', featureKey: 'access-requests' },
  ...
  { id: 'integrations', path: '/integrations', label: 'Integrations', icon: 'hub', featureKey: 'settings' },
  { id: 'config-variables', path: '/integrations/config-variables', label: 'Config Variables', icon: 'tune', featureKey: 'settings' },
  { id: 'credentials', path: '/integrations/credentials', label: 'Credentials', icon: 'key', featureKey: 'settings' },
  { id: 'sync-queue', path: '/integrations/sync-queue', label: 'Sync Queue', icon: 'sync', featureKey: 'settings' },
