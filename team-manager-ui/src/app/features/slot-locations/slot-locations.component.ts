  ...
  template: `
    <div style="max-width:800px;margin:0 auto;padding:0 8px">
      <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:16px">
        <h2 style="margin:0;font-size:1.3rem;font-weight:700">Meeting Locations</h2>
      ...
      <div style="display:flex;flex-direction:column;gap:6px">
        ...
        @if (locations().length === 0) {
          <div style="text-align:center;padding:48px;opacity:0.35">No locations configured. Add one above.</div>
        }
      </div>
    </div>
  `,
...
export class SlotLocationsComponent implements OnInit {
