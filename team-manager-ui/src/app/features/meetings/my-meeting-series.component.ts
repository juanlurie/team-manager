...
@Component({
            ...
            <div class="actions">
              @if (s.openItems > 0) {
                <button mat-raised-button color="primary"
                        [routerLink]="['/meetings', 'series', s.seriesId, 'availability']">
              ...
              <button mat-stroked-button
                      [routerLink]="['/meetings', 'series', s.seriesId]">
                View Series
              </button>
            </div>
          </div>
  ...
  styles: [`
    ...
    .stat { display:inline-flex;align-items:center;gap:4px;font-size:0.78rem;opacity:0.6; }
